...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ticket.is_linked_to'
        db.add_column(u'tickets_ticket', 'is_linked_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'related_tickets', null=True, to=orm['tickets.Ticket']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Ticket.is_linked_to'
        db.delete_column(u'tickets_ticket', 'is_linked_to_id')
    ...
    models = {
        ...
        u'tickets.ticket': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_linked_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'related_tickets'", 'null': 'True', 'to': u"orm['tickets.Ticket']"}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'parent_ticket': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'children'", 'null': 'True', 'to': u"orm['tickets.Ticket']"}),
